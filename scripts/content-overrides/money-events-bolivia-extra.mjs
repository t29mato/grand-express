...
export const BOLIVIA_MONEY_EVENTS_EXTRA = [
  ...
  ev(
    ...
    "A workshop in Aiquile is behind before the fair and pays for a hand fitting and tuning the strings. The town holds Bolivia's national charango contest, and the instrument's soundbox was once made from the shell of an armadillo.|Un taller de Aiquile va con retraso antes de la feria y paga por una mano que encuerde y afine. El pueblo acoge el concurso nacional de charango, y la caja del instrumento se hacía antes con caparazón de quirquincho.|Un atelier d'Aiquile est en retard avant la foire et paie pour un coup de main : monter et accorder les cordes. Le bourg accueille le concours national de charango, et la caisse de l'instrument se faisait jadis d'une carapace de tatou.|祭りを前にアイキレの工房が手一杯で、弦を張って調律する手伝いに日当が出た。この町では全国チャランゴ大会が開かれ、この楽器の胴はかつてアルマジロの甲羅で作られていた。",
  ),
  ...
  ev(
    ...
    "A herding family is short of hands and pays by the fleece. Llamas are shorn only every second year, and Bolivia keeps more of them than any other country.|Una familia pastora anda escasa de manos y paga por vellón. A las llamas se las esquila solo cada dos años, y Bolivia tiene más que ningún otro país.|Une famille d'éleveurs manque de bras et paie à la toison. On ne tond les lamas que tous les deux ans, et la Bolivie en élève plus que tout autre pays.|毛刈りの季節に人手が足りず、一頭いくらで手伝った。リャマの毛を刈るのは2年に一度で、この国は世界のどこよりも多くのリャマを飼っている。",
  ),
  ev(
    "mine-gifts", "loss", ["alt"], "🧨", 220,
    "Gifts for the mining crews|Regalos para las cuadrillas|Cadeaux pour les équipes|坑夫への手みやげ",
    "Nobody goes underground at Cerro Rico without the customary gifts from the miners' market — coca leaves, fizzy drinks, even dynamite. The mountain financed the Spanish crown for two centuries and is still worked today by cooperatives.|Nadie baja al Cerro Rico sin los regalos de rigor del mercado minero: hoja de coca, gaseosas, hasta dinamita. El cerro sostuvo a la corona española durante dos siglos y hoy lo siguen picando las cooperativas.|Personne ne descend dans le Cerro Rico sans les cadeaux d'usage achetés au marché des mineurs : feuilles de coca, sodas, jusqu'à la dynamite. La montagne a financé la couronne d'Espagne deux siècles durant et reste creusée par des coopératives.|セロ・リコの坑道に入る前、鉱夫市場で坑夫への手みやげを買う——コカの葉、炭酸飲料、ダイナマイトまでが普通に並ぶ。この山は二世紀にわたりスペイン王室を支え、いまも協同組合が掘り続けている。",
  ),
  ...
  ev(
    ...
    "Rain brings the hillside down across the road, and the citrus and coffee on the truck spoil during the wait. This slope feeds La Paz its fruit, and every wet season a derrumbe cuts the only way up.|La lluvia echa la ladera sobre la carretera y los cítricos y el café del camión se pierden durante la espera. Esta ladera abastece de fruta a La Paz, y cada época de lluvias un derrumbe corta el único camino de subida.|La pluie fait descendre le versant sur la route et les agrumes et le café du camion s'abîment pendant l'attente. Ce versant nourrit La Paz en fruits, et chaque saison des pluies un éboulement coupe l'unique montée.|雨で斜面が道の上に崩れ、待っているあいだに積んでいた柑橘と珈琲が傷んだ。この斜面がラパスの果物を賄っており、雨季のたびに崩落が唯一の登り道を断つ。",
  ),
  ...
  ev(
    ...
    "Smoke from the chaqueo — the clearing fires lit every year before the rains — closes the airstrip, and the unplanned nights have to be paid for. In a bad year the haze shuts airports hundreds of kilometres away.|El humo del chaqueo —las quemas que se encienden cada año antes de las lluvias— cierra la pista, y hay que pagar noches que nadie había previsto. En un mal año la calina cierra aeropuertos a cientos de kilómetros.|La fumée du chaqueo — les feux d'essartage allumés chaque année avant les pluies — ferme la piste, et il faut payer des nuits imprévues. Une mauvaise année, la brume ferme des aéroports à des centaines de kilomètres.|雨季の前に毎年放たれる焼き畑「チャケオ」の煙で滑走路が閉じ、予定に無い宿代がかさんだ。ひどい年には数百キロ離れた空港まで霞んで閉まる。",
  ),
];

...
倍率200000。**2026-08-21、team-leadが実勢レートで測り直し、当初の265000
(1ドル≒152円・1ドル≒4050ペソという仮定)は実勢より31%高く出ていたと
指摘を受けた。**実勢は1COP≒0.0495円(1円≒20.2ペソ、直近30日の変動幅
19.49〜20.88ペソ/円)で、12,000,000÷0.0495÷1200≒202,020。倍率にすると
195,000〜209,000の範囲に収まる200,000へ修正した(コロンビア・ペソは
対円で非常に単価が低いため、他盤面と比べ倍率の桁が大きくなる)。

**表記も直した。**`$` 単独は世界一周・USA・ベネズエラ・大陸盤4枚が
米ドル(倍率100)の意味で使う慣習になっており、`$`のままだと同じ記号で
2650倍の開きが出てしまっていた。メキシコ・ペソの`MX$`(倍率1200)に
ならい、`COL$`に直した。

```js
  // COL$ 1,200 → COL$ 240,000,000。1COP≒0.0495円(1円≒20.2ペソ、
  // 2026-08-21時点の直近30日の変動幅19.49〜20.88ペソ/円)として
  // 12,000,000÷0.0495÷1200≒202,020を200,000に丸めた。
  colombia: 200000,
```
...
通貨倍率      200000(表記COL$。使ったレート: 1COP≒0.0495円、
              2026-08-21時点。上記2番参照)
```

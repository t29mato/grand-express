...
## 追記(2026-08-21・アルゼンチン盤担当との相互レビュー結果)

**3件が確認され、1件は問いごと差し替えました。**

1. **アルフレッド・クルーガーの前歴(サウスカロライナ)→ 出典が競合し確定不可。差し替え済み。**
   ウェブ検索で「ジョージア中央鉄道の測量」「C&O運河の辞職」「フォメント公社への
   招聘」の3つの記述が並立し、一本化できないと判明。この問い(旧・難易度9)は
   **削除し**、代わりに同じ調べもので裏付けられた事実(1837年の人手不足の報告
   ——砂糖のための鉄道が、砂糖に人手を取られて作れなかった)を使った新しい問い
   に差し替えた(difficulty 9、キューバのUSキー入れ替えなし)。
2. **ラ・トロチャの長さ(70km)→ 確認済み。**フカロ―モロン間68km(1869〜1872年
   建設)。「およそ70km」のままで問題ないとのこと。
3. **マナカ・イスナガの塔がイスナガ家の奴隷貿易の富で建てられたこと→ 確認済み。**
   ペドロ・イスナガが1795年に農園を買い、奴隷貿易でキューバ有数の富豪になった。
   塔は1816年にアレホ・マリア・イスナガ・イ・ボレルが建設(高さ44〜45m・184段)。
   もとの問い(難易度10)はそのままでよい。

**新しく足した問い(difficulty 7)。**トロチャの鉄道は、それまでのキューバの
鉄道(すべて民間の砂糖資本)と違い、**植民地政府自身が建設・運営した最初の
鉄道**だった、という事実。労働力は奴隷と中国人年季契約移民。

## 難易度9〜10・確度が中程度の項目(自己申告、上記3件を除く)

以下は一次資料までは当たれておらず、確度「中」として報告する。
**相互レビューで優先して見てほしい。**

```
1. ビリャヌエバ駅(ハバナの最初の鉄道駅の名)が解体されたという前提
   (駅名がビリャヌエバ伯にちなむこと自体は確度が高い)
2. シエンフエゴスの元の名前「フェルナンディーナ・デ・ハグア」
3. イスラ・デ・ラ・フベントゥへの改名年(1978年)
4. レナード・ウッドが1902年にキューバ初代大統領へ権限を引き渡した将軍で
   あること(在任期間・役職名の細部)
5. ペルーチョ・フィゲレド処刑年(1870年)
6. ヘスス・メネンデス暗殺年(1948年)
7. マナカ・イスナガの塔が7階建てとされること(高さ44〜45m・184段までは
   相互レビューで確認済みだが、「7階建て」自体は別の主張で未確認)
8. Bacardí社の1862年創業(サンティアゴ・デ・クーバ)は確度高いが、

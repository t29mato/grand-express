 ...
 *
 * **`scripts/countries/africa/quiz.mjs` の南アフリカ関連の問い(通貨・
 * 国歌の言語数・3つの首都・27年間の投獄・ロベン島・ウブントゥ・
 * デズモンド・ツツのノーベル賞・アパルトヘイトの語源・クリック音・
 * ンデベレ/ズールー語族・アフリカペンギン・ルイボス・ピリピリなど)とも
 * 重ならないことを確認済み。最初の下書きでは通貨(ランド)と国歌(5言語)が
 * どちらもアフリカ盤のQ168・Q623と一字一句同じ問いになっていたため、
 * 国花/クリケットの愛称とディストリクト・シックスの強制移住に差し替えた。
 *

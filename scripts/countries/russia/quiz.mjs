...
export const RUSSIA_QUIZ = [
  ...
  q(
    5,
    "Who became the first woman in space, in 1963?|¿Quién se convirtió en la primera mujer en el espacio, en 1963?|Qui devint la première femme dans l'espace, en 1963 ?|1963年に世界初の女性宇宙飛行士になったのは誰か?",
    ["Valentina Tereshkova|Valentina Tereshkova|Valentina Terechkova|ワレンチナ・テレシコワ", "Svetlana Savitskaya|Svetlana Savítskaya|Svetlana Savitskaïa|スヴェトラーナ・サビツカヤ", "Anna Kikina|Anna Kikina|Anna Kikina|アンナ・キキナ"],
    0,
    "Tereshkova, a former textile-factory worker and amateur parachutist before her selection, orbited the Earth 48 times over three days aboard Vostok 6, a record no other solo woman has since matched in a single flight.|Tereshkova, antigua obrera textil y paracaidista aficionada antes de ser seleccionada, orbitó la Tierra 48 veces en tres días a bordo del Vostok 6, un récord que ninguna otra mujer en solitario ha igualado desde entonces.|Terechkova, ancienne ouvrière du textile et parachutiste amateur avant sa sélection, orbita autour de la Terre 48 fois en trois jours à bord de Vostok 6, un record qu'aucune autre femme seule n'a égalé depuis en un seul vol.|選抜される前は紡績工場の労働者でアマチュアのパラシュート選手でもあったテレシコワは、ヴォストーク6号で3日間に48回地球を周回した。この記録は、以後どの女性単独飛行者にも破られていない。",
  ),
  q(
    5,

...
export const CHILE_CITIES = {
  ...
  antofagasta: city(
    ...
    [prop("Nitrate Railway Wharf|Muelle del ferrocarril salitrero|Quai du chemin de fer du salpêtre|硝石鉄道の埠頭", 340, 70),
  ...
  iquique: city(
    ...
    [prop("Santa María School Memorial|Memorial de la Escuela Santa María|Mémorial de l'école Santa María|サンタ・マリア学校の慰霊碑", 260, 54),
     prop("Palacio Astoreca Courtyard|Patio del Palacio Astoreca|Cour du Palacio Astoreca|アストレカ宮殿の中庭", 360, 74)],
  ),
  ...
  santiago: city(
    ...
    [prop("Estación Central Platform Shop|Local en el andén de la Estación Central|Boutique de quai de l'Estación Central|エスタシオン・セントラルの構内店", 420, 86),
     prop("Smog-Season Apartment Block|Edificio de departamentos en temporada de esmog|Immeuble d'appartements en saison de smog|スモッグの季節のアパート", 360, 74)],
  ),
  ...
  valparaiso: city(
    ...
    [prop("Ascensor Cable House|Casa de máquinas del ascensor|Cabine de treuil de l'ascensor|アセンソールの巻上げ小屋", 300, 62),
     prop("Hillside Cerro Bar|Bar de cerro|Bar de colline|丘の上のバー", 240, 50)],
  ),
  ...
  vinadelmar: city(
    ...
    [prop("Flower Clock Garden Plot|Parcela del jardín del reloj de flores|Parcelle du jardin de l'horloge fleurie|花時計庭園の一角", 320, 66),
     prop("Seafront Casino Terrace|Terraza del casino frente al mar|Terrasse du casino en front de mer|海沿いカジノのテラス", 380, 78)],
  ),
  ...
  rancagua: city(
    ...
    [prop("Tunnel Entrance Portal|Portal de entrada al túnel|Portail d'entrée du tunnel|坑道入口のポータル", 360, 74),
  ...
  concepcion: city(
    ...
    [prop("Earthquake Memorial Plaza|Plaza memorial del terremoto|Place mémorielle du séisme|地震の慰霊広場", 260, 54),
     prop("Coal Export Rail Yard|Patio ferroviario de exportación de carbón|Cour ferroviaire d'exportation du charbon|石炭輸出の鉄道操車場", 300, 62)],
  ),
  ...
  puntaarenas: city(
    ...
    [prop("Wool Warehouse Loading Dock|Muelle de carga de la bodega lanera|Quai de chargement de l'entrepôt à laine|羊毛倉庫の積み込み埠頭", 320, 66),
     prop("Belle Époque Mansion Courtyard|Patio de la mansión de la Belle Époque|Cour de la demeure Belle Époque|ベル・エポック様式の邸宅の中庭", 380, 78)],
  ),

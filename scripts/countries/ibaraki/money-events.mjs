...
export const IBARAKI_MONEY_EVENTS = [
  ...
  ev(
    ...
    "You spend a morning weighing and sealing bags in a farm shed, and are paid in cash and broken pieces. Ibaraki dries about nine tenths of all the hoshi-imo eaten in Japan: the potatoes are steamed, sliced and left out in the dry winter wind off the sea.|Pasas una mañana pesando y cerrando bolsas en un cobertizo, y te pagan en efectivo y en trozos rotos. Ibaraki seca cerca de nueve décimas partes del hoshi-imo de Japón: se cuece al vapor, se corta y se deja al viento seco del invierno.|Tu passes une matinée à peser et fermer des sachets dans un hangar, payé en espèces et en morceaux cassés. Ibaraki sèche près des neuf dixièmes du hoshi-imo japonais : cuit à la vapeur, tranché, puis laissé au vent sec d'hiver.|農家の作業小屋で午前中ずっと計量と袋詰めをして、現金と欠けたぶんをもらった。茨城は日本で食べられる干し芋のおよそ九割を作る。蒸してから薄く切り、海から吹く冬の乾いた風に当てて干す。",
  ),
  ev(
    ...
    "You take a turn on the till while the growers are still in the fields, and are sent home with whatever did not sell. Ibaraki has one of the highest farm-stall turnovers in the country, because the growers are close enough to the cities to sell straight to the eater and skip the market entirely.|Cubres la caja mientras los agricultores siguen en el campo, y te mandas a casa con lo que no se vendió. Ibaraki tiene una de las mayores ventas directas del país: el campo está lo bastante cerca de las ciudades.|Tu tiens la caisse pendant que les maraîchers sont encore aux champs, et repars avec les invendus. Ibaraki compte parmi les plus forts chiffres de vente directe du pays : les champs sont assez près des villes.|作り手がまだ畑にいるあいだ、レジの当番を代わった。売れ残りを持たされて帰る。茨城は農産物直売所の売上が全国有数である。畑が都市に近く、市場を通さず食べる人へ直に売れるからだ。",
  ),
  ev(
    "one-car-per-adult", "loss", [], "⛽", 200,
    "Everything is a drive away|Todo queda a un trayecto|Tout est à une voiture d'ici|どこへ行くにも車",
    "The place you want is twenty minutes off the nearest line, so you fill the tank twice in a week. Ibaraki has one of the highest rates of cars per household in the country, because outside the few rail corridors the buses are thin and the distances are flat and long.|El sitio que buscas queda a veinte minutos de la línea más cercana, y llenas el depósito dos veces en una semana. Ibaraki tiene una de las tasas más altas de coches por hogar del país.|L'endroit visé est à vingt minutes de la ligne la plus proche : tu fais deux pleins dans la semaine. Ibaraki compte l'un des taux de voitures par ménage les plus élevés du pays.|行きたい場所は最寄りの線から車で二十分の所にあり、一週間で二度給油することになった。茨城は一世帯あたりの自動車保有台数が全国でも多い県である。数少ない鉄道沿線を外れるとバスは細く、平らな道がどこまでも続く。",
  ),
  ev(
  ...
  ev(
    ...
    "The road up to the frozen waterfall is sheet ice, and you buy what you should have fitted before setting out. In the coldest years the whole 120-metre face turns to ice and the queue of cars starts before dawn, most of them from places that never see snow.|La subida a la cascada helada es una placa de hielo y compras lo que debiste montar antes de salir. En los años más fríos toda la pared de 120 m se congela y la fila empieza antes del alba.|La montée vers la chute gelée est une plaque de glace : tu achètes ce que tu aurais dû monter avant de partir. Les années les plus froides, les 120 m gèlent entièrement.|凍った滝へ上る道は一面の氷で、出る前に履いておくべきものをその場で買う羽目になった。寒い年には高さ120mの岩壁がまるごと凍りつき、夜明け前から車の列ができる。並ぶ車の多くは雪の降らない土地のものである。",
    [9, 10],
  ),
  ...
  ev(
    ...
    "The festival needs more hands than the town has, and you carry trays from dawn until the last visitor leaves. Kairakuen holds three thousand plum trees of a hundred varieties, and because they open over six weeks rather than all at once, the crowds keep coming through February and March.|La fiesta necesita más manos de las que tiene el pueblo, y llevas bandejas desde el alba. Kairakuen guarda tres mil ciruelos de cien variedades que abren a lo largo de seis semanas, no de golpe.|La fête réclame plus de bras que la ville n'en a : tu portes des plateaux dès l'aube. Kairakuen compte trois mille pruniers de cent variétés, qui s'ouvrent sur six semaines et non d'un coup.|梅まつりは町の人手だけでは足りず、夜明けから最後の客が帰るまで盆を運んだ。偕楽園には百品種三千本の梅がある。一斉ではなく六週間かけて順に咲くので、二月から三月いっぱい人が絶えない。",
    [10, 11],
  ),
  ev(
  ...
  ev(
    ...
    "You are put on the line to turn each melon and listen while a machine reads its sugar through the skin. Ibaraki ships more melons than any other prefecture and staggers the varieties so the harvest runs from spring into autumn, which is why the shed needs people for months rather than weeks.|Te ponen en la línea a girar cada melón mientras una máquina le lee el azúcar a través de la piel. Ibaraki envía más melones que ninguna otra prefectura y escalona las variedades.|On te met à la chaîne pour retourner chaque melon pendant qu'une machine lit le sucre à travers la peau. Ibaraki expédie plus de melons que toute autre préfecture, en échelonnant les variétés.|選果場の列に入れられ、機械が皮ごしに糖度を読むあいだ、一つずつメロンを回す役についた。茨城はメロンの出荷量が全国一で、品種をずらしてあるため収穫は春から秋まで続く。作業場が数週間ではなく数か月人を要るのはそのためだ。",
    [1, 2],
  ),
  ev(
    ...
    "Every inn along the canals is full for the iris festival and you pay twice the rate two towns away. The irises open for about three weeks in June, and the town brings back the boats that once carried brides between the villages to take visitors down the same channels.|Todas las posadas del canal están llenas por la fiesta del lirio y pagas el doble a dos pueblos de distancia. Los lirios abren unas tres semanas en junio.|Toutes les auberges des canaux affichent complet pour la fête des iris : tu paies le double à deux villages de là. Les iris fleurissent trois semaines en juin.|あやめ祭りのあいだ、水路沿いの宿はどこも満室で、二つ先の町で倍の宿代を払った。あやめは六月の三週間ほど咲く。町はかつて村から村へ花嫁を運んだ舟を出し、同じ水路で客を乗せる。",
    [2],
  ),
  ...
  ev(
    ...
    "Paid to sit in a machine|Pagado por sentarte en una máquina|Payé pour t'asseoir dans une machine|実験に協力して謝礼をもらう",
    "A notice on a corridor board asks for volunteers, and two hours later you are being paid to press buttons in a quiet room. Dozens of national laboratories were moved here in the 1970s and put down in one place, so a town of this size runs on the odd economy of research.|Un aviso en un tablón pide voluntarios y dos horas después te pagan por pulsar botones en una sala silenciosa. Decenas de laboratorios nacionales se trasladaron aquí en los años setenta.|Une annonce sur un panneau cherche des volontaires ; deux heures plus tard on te paie pour appuyer sur des boutons dans une salle silencieuse. Des dizaines de laboratoires nationaux y furent transférés dans les années 1970.|廊下の掲示板に被験者募集の紙が貼ってあり、二時間後には静かな部屋でボタンを押して謝礼をもらっていた。1970年代に数十の国立研究機関がここへまとめて移された。この規模の町が研究という妙な経済で回っているのはそのためである。",
  ),
  ev(
    ...
    "One road climbs to the grove and every car in the region is on it, so you pay for parking you barely use. The plums on the mountain open a little later than the ones in the castle town, which means the same fortnight fills two different places with the same cars.|Un solo camino sube al ciruelar y todos los coches de la comarca están en él, así que pagas un aparcamiento que apenas usas. Los ciruelos del monte abren algo más tarde que los de la ciudad.|Une seule route monte au verger et toutes les voitures de la région y sont : tu paies un parking à peine utilisé. Les pruniers du mont fleurissent un peu après ceux de la ville.|梅林へ上る道は一本きりで、界隈じゅうの車がそこにいる。ほとんど使わない駐車場に金を払った。山の梅は城下町の梅より少し遅れて咲くので、同じ二週間が二つの場所を同じ車で埋める。",
    [10],
  ),
  ...
  ev(
    ...
    "A week of hard dry wind off the mountains, and you pay to have the sand washed out of everything you own. The same wind is what dries the sweet potato on the coast, so the season that costs you here is the one that pays two counties east.|Una semana de viento seco de la montaña y pagas por sacar la arena de todo lo que tienes. Ese mismo viento es el que seca el boniato en la costa.|Une semaine de vent sec descendu des monts, et tu paies pour ôter le sable de tout ce que tu possèdes. C'est ce vent-là qui sèche la patate douce sur la côte.|山から乾いた風が一週間吹き続け、持ち物すべてから砂を洗い落とす費用がかかった。同じ風が、海沿いでは干し芋を乾かしている。ここで出費になる季節が、二郡東では実入りになっているということだ。",
    [8, 9],
  ),
];

 ...
 * (他の盤面も12種前後)。1種で複数の題材を受け持つので、**その中で
 * いちばん形が強いもの**を描けばよい。
 *
 * | キー | 描くもの | 受け持つ町 |
 * |---|---|---|
 * | `plum`        | 枝に咲く花(梅・桃) | 水戸・古河 |
 * | `flowerfield` | 群れて咲く花(あやめ・ひまわり・ネモフィラ) | 潮来・那珂・ひたちなか |
 * | `faith`       | 鳥居(山門・大仏も兼ねる) | 大洗・鹿嶋・牛久・稲敷・つくばみらい |
 * | `science`     | 研究(ロケット・原子) | つくば・東海 |
 * | `airplane`    | 飛行機 | 小美玉・阿見 |
 * | `boat`        | 舟(帆引き船・渡し船) | かすみがうら・取手・境 |
 * | `harvest`     | 畑の実り(メロン・さつまいも・ピーマン) | 鉾田・行方・神栖 |
 * | `craft`       | 手仕事(窯・織機・石工) | 笠間・結城・桜川 |
 * | `steam`       | 機械と蒸気(電動機・蒸気機関車) | 日立・筑西 |
 * | `brush`       | 筆(絵と書物) | 北茨城・常陸太田 |
 * | `festival`    | 祭り(花火・獅子頭・屋台・撞舞) | 土浦・石岡・常陸大宮・龍ケ崎 |
 * | `scenery`     | 眺め(滝・紅葉・沼) | 大子・高萩・下妻 |
 * | `castle`      | 城と武者 | 常総・坂東 |
 */
...
export const IBARAKI_CITIES = {
  ...
  mito: city(
    "Mito|Mito|Mito|水戸",
    140.47, 36.37, "cen", "plum", "castletown", "r",
  ...
  kasama: city(
    ...
    140.30, 36.35, "cen", "craft", "pottery", "l",
  ...
  oarai: city(
    ...
    140.57, 36.31, "cen", "faith", "seaside", "r",
  ...
  hitachinaka: city(
    ...
    140.53, 36.40, "cen", "flowerfield", "coasttown", "l",
  ...
  tokai: city(
    ...
    140.57, 36.47, "cen", "science", "harbourtown", "r",
  ...
  omitama: city(
    ...
    140.35, 36.24, "cen", "airplane", "ricefield", "r",
  ...
  naka: city(
    "Naka|Naka|Naka|那珂",
    140.49, 36.46, "hok", "flowerfield", "ricefield", "l",
  ...
  hitachi: city(
    ...
    140.65, 36.60, "hok", "steam", "harbourtown", "r",
  ...
  kitaibaraki: city(
    ...
    140.75, 36.80, "hok", "brush", "seaside", "r",
  ...
  takahagi: city(
    ...
    140.72, 36.71, "hok", "scenery", "valley2", "l",
  ...
  hitachiota: city(
    ...
    140.53, 36.54, "hok", "brush", "villagehouse", "l",
  ...
  hitachiomiya: city(
    ...
    140.41, 36.55, "hok", "festival", "villagehouse", "r",
  ...
  daigo: city(
    ...
    140.35, 36.77, "hok", "scenery", "valley2", "l",
  ...
  kashima: city(
    ...
    140.64, 35.97, "rok", "faith", "shrineforest", "r",
  ...
  itako: city(
    ...
    140.58, 35.925, "rok", "flowerfield", "wetland", "r",
  ...
  kamisu: city(
    ...
    140.66, 35.89, "rok", "harvest", "seaside", "r",
  ...
  namegata: city(
    ...
    // 台地が広くなる玉造側に置く。
    140.45, 36.06, "rok", "harvest", "ricefield", "l",
  ...
  hokota: city(
    ...
    140.52, 36.16, "rok", "harvest", "ricefield", "r",
  ...
  tsukuba: city(
    ...
    140.11, 36.08, "nan", "science", "citygreen", "r",
  ...
  tsuchiura: city(
    ...
    140.17, 36.09, "nan", "festival", "lakeport", "l",
  ...
  ishioka: city(
    ...
    140.29, 36.19, "nan", "festival", "castletown", "r",
  ...
  kasumigaura: city(
    ...
    // 市域の西半分(千代田側)に置く。
    140.25, 36.13, "nan", "boat", "lakeport", "r",
  ...
  ryugasaki: city(
    ...
    140.18, 35.91, "nan", "festival", "ricefield", "r",
  ...
  toride: city(
    ...
    140.05, 35.91, "nan", "boat", "riverport", "l",
  ...
  ami: city(
    "Ami|Ami|Ami|阿見",
    140.21, 36.03, "nan", "airplane", "ricefield", "r",
  ...
  inashiki: city(
    ...
    140.32, 35.96, "nan", "faith", "wetland", "l",
  ...
  tsukubamirai: city(
    ...
    140.04, 35.96, "nan", "faith", "ricefield", "r",
  ...
  koga: city(
    "Koga|Koga|Koga|古河",
    139.75, 36.18, "sei", "plum", "castletown", "l",
  ...
  yuki: city(
    "Yūki|Yūki|Yūki|結城",
    139.88, 36.31, "sei", "craft", "villagehouse", "r",
  ...
  chikusei: city(
    ...
    139.98, 36.30, "sei", "steam", "castletown", "l",
  ...
  sakuragawa: city(
    ...
    140.09, 36.33, "sei", "craft", "villagehouse", "r",
  ...
  shimotsuma: city(
    ...
    139.97, 36.18, "sei", "scenery", "ricefield", "l",
  ...
  joso: city(
    "Jōsō|Jōsō|Jōsō|常総",
    139.99, 36.02, "sei", "castle", "riverport", "r",
  ...
  bando: city(
    ...
    139.89, 36.05, "sei", "castle", "ricefield", "l",
  ...
  sakai: city(
    "Sakai|Sakai|Sakai|境",
    139.79, 36.11, "sei", "boat", "riverport", "r",

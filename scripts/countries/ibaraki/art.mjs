...
export const IBARAKI_MARKS = {
   ...
   * 丸い頭に肉髻(頂の盛り上がり)を載せ、衣を縦の襞で落とす。
   *
   * 色は青銅。緑青ではなく**焦げた茶色の銅**にしてある。
   * 背景(`citygreen`)が緑の丘と青空なので、緑にすると溶ける
   * (docs/50-authoring/12-city-background-guide.md 4.2 と同じ話)。
   */
  daibutsu:
    // 蓮華座(低く抑える。像の高さを稼ぐため)
    '<path d="M2.8,23.4q9.2,-3 18.4,0z" fill="#8a7250"/>' +
    '<path d="M4.2,21.8q7.8,-2.6 15.6,0q-3.2,1.4 -7.8,1.4q-4.6,0 -7.8,-1.4z" fill="#a08663"/>' +
    '<g fill="#8a7250"><path d="M6.6,21.4q1.8,-2.2 3.6,0zM11,20.9q1.8,-2.2 3.6,0zM15.4,21.4q1.8,-2.2 3.6,0z"/></g>' +
    // 衣。**幅を絞って縦に伸ばす。**120mの立像なので、細長いことが特徴
    '<path d="M10.2,7.4h3.6l2.4,14.2H7.8z" fill="#7a6a54"/>' +
    '<path d="M10.2,7.4h1.8l0.2,14.2H7.8z" fill="#8f7d63"/>' +
    '<g stroke="#5f523f" stroke-width="0.55" fill="none"><path d="M10.6,9.6L9.4,21.4M13.4,9.6L14.6,21.4M12,9.6V21.4"/></g>' +
    // 腕。左を胸へ上げ、右は身に沿って下ろす(細く、衣に沿わせる)
    '<path d="M14.2,9.4q2.2,1 2,3.6l-1.5,0q0.1,-1.8 -1.3,-2.4z" fill="#8f7d63"/>' +
    '<path d="M14.6,12.6q1.5,-0.3 1.6,1.1q0.1,1.2 -1.2,1.2q-1,0 -1,-1.1z" fill="#a08663"/>' +
    '<path d="M9.8,9.4q-2,1 -1.9,4.2l1.5,0q-0.1,-2.4 1.1,-3z" fill="#7a6a54"/>' +
    '<path d="M8,14q1.3,-0.3 1.4,1.1q0.1,1.2 -1.1,1.2q-1,0 -1,-1.1z" fill="#8f7d63"/>' +
    // 頭。**小さく**して像を高く見せる
    '<circle cx="12" cy="5.2" r="2.3" fill="#8f7d63"/>' +
    // 螺髪(頭の上半分)。**目にかからない高さで切る**
    '<path d="M9.7,4.8a2.3,2.3 0 0 1 4.6,0z" fill="#7a6a54"/>' +
    '<circle cx="12" cy="2.6" r="1.15" fill="#7a6a54"/>' +
    // 伏し目(仏像の目は閉じている。点で描くと覆面に見えた)
    '<g stroke="#5f523f" stroke-width="0.5" fill="none" stroke-linecap="round">' +
    '<path d="M10.5,5.7q0.6,0.45 1.2,0M12.3,5.7q0.6,0.45 1.2,0"/></g>' +
    '<path d="M11.3,6.9q0.7,0.4 1.4,0" stroke="#5f523f" stroke-width="0.5" fill="none" stroke-linecap="round"/>' +

...
export const INDIA_QUIZ = [
  ...
  q(
    6,
    "Which country did Goa belong to until 1961?|¿A qué país perteneció Goa hasta 1961?|À quel pays Goa appartint-elle jusqu'en 1961 ?|ゴアが1961年まで属していた国は?",
    [
      "Portugal|Portugal|Le Portugal|ポルトガル",
      "The Netherlands|Los Países Bajos|Les Pays-Bas|オランダ",
      "France|Francia|La France|フランス",
    ],
    0,
    "Portugal held Goa for 451 years, longer than any other European power held any part of India.|Portugal tuvo Goa 451 años, más de lo que ninguna otra potencia europea retuvo parte alguna de la India.|Le Portugal garda Goa 451 ans, plus longtemps qu'aucune autre puissance européenne ne tint une partie de l'Inde.|ポルトガルは451年間ゴアを領有し、これはヨーロッパのどの国がインドのどの地を保った期間よりも長いものです。",
  ),
  q(
    7,
  ...
  q(
    9,
    "What was Vijayanagara, whose ruins stand at Hampi?|¿Qué fue Vijayanagara, cuyas ruinas están en Hampi?|Que fut Vijayanagara, dont les ruines sont à Hampi ?|ハンピに廃墟が残るヴィジャヤナガルとは?",
    [
      "A Portuguese trading fort|Un fuerte comercial portugués|Un comptoir fortifié portugais|ポルトガルの商館砦",
      "One of the largest cities in the world around 1500|Una de las mayores ciudades del mundo hacia 1500|L'une des plus grandes villes du monde vers 1500|1500年頃、世界有数の大都市",
      "A Buddhist monastery complex|Un complejo monástico budista|Un complexe monastique bouddhique|仏教僧院群",
    ],
    1,
    "Visitors described markets where diamonds were sold by the measure; the city was sacked in 1565 and never reoccupied.|Los visitantes describían mercados donde los diamantes se vendían a medida; saqueada en 1565, nunca se repobló.|Des visiteurs décrivaient des marchés où les diamants se vendaient à la mesure ; pillée en 1565, la ville ne fut jamais réoccupée.|訪れた者は、ダイヤが升で売られる市場を書き残しました。1565年に略奪され、再び人が住むことはありませんでした。",
  ),
  q(
    9,
    "Which Indian state was an independent kingdom until 1975?|¿Qué estado indio fue un reino independiente hasta 1975?|Quel État indien fut un royaume indépendant jusqu'en 1975 ?|1975年まで独立王国だったインドの州は?",
    [
      "Sikkim|Sikkim|Le Sikkim|シッキム",
      "Kerala|Kerala|Le Kerala|ケーララ",
      "Odisha|Odisha|L'Odisha|オディシャ",
    ],
    0,
    "A referendum ended the Buddhist monarchy and made Sikkim India's 22nd state; it is now fully organic by law.|Un referéndum acabó con la monarquía budista y convirtió a Sikkim en el estado 22; hoy es totalmente ecológico por ley.|Un référendum mit fin à la monarchie bouddhiste et fit du Sikkim le 22e État ; il est aujourd'hui entièrement bio par la loi.|住民投票で仏教王制が終わり、シッキムはインド22番目の州となりました。今では法律により完全有機農業です。",
  ),
  q(
    10,

...
export const INDIA_EDGES = [
  ...
  // 航路
  ["mumbai", "goa", "sea"],
  // つなぎ替え済み(陸144px → 6px)。ドワルカ—ムンバイは、どちらの折れ方でも
  // カティアワール半島を横切っていた(そのまま172px・入れ替え144px・陸路211px)。
  // 半島の南岸に町が無いので、2本の脚では回り込めない。ゴアからアラビア海を
  // 沖伝いに北上する形にすると全部海の上に収まる。ムンバイ—ゴアの短い航路は
  // 残っているので、沿岸の便と長距離の便が並ぶ形になる。
  ["goa", "dwarka", "sea"],
  ["kochi", "kavaratti", "sea"],

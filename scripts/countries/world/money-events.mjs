...
export const WORLD_MONEY_EVENTS = [
  ...
  ev(
    ...
    "Working your passage|Trabajando el pasaje|Payer sa traversée en travaillant|甲板を手伝って乗せてもらう",
    "You take a line, wash down the deck and stand a watch, and are carried a stage of the journey for nothing plus a little cash. A cargo ship may take up to twelve passengers before it counts as a passenger vessel and needs a doctor aboard, which is why freighters carry exactly that many and no more.|Coges un cabo, baldeas la cubierta y haces una guardia, y te llevan una etapa del viaje gratis y con algo de dinero encima. Un carguero puede llevar hasta doce pasajeros antes de contar como buque de pasaje y necesitar médico a bordo: por eso llevan justo esos doce y ni uno más.|Tu prends un bout, tu lessives le pont et tu prends un quart : on te transporte une étape pour rien, plus un peu d'argent. Un cargo peut embarquer jusqu'à douze passagers avant d'être classé navire à passagers et de devoir un médecin à bord ; c'est pourquoi les cargos en prennent douze, jamais treize.|舫いを取り、甲板を洗い、当直に立って、一区間ただで運んでもらったうえに少し現金までもらった。貨物船は乗客が十二人を超えると旅客船扱いになり、船医を乗せなければならない。だから貨物船の客はきっかり十二人で、それ以上は乗せない。",
  ),
  ev(
    "standing-between", "gain", [], "🗣️", 160,
    "Standing between two people|De pie entre dos personas|Debout entre deux personnes|二人のあいだに立つ",
    "Half an hour at a hospital counter, translating in both directions, and the family will not let you leave without taking something. Around seven thousand languages are counted in the world, and about half of them have fewer than ten thousand speakers left.|Media hora en el mostrador de un hospital, traduciendo en ambos sentidos, y la familia no te deja marchar sin aceptar algo. En el mundo se cuentan unas siete mil lenguas, y a la mitad les quedan menos de diez mil hablantes.|Une demi-heure au guichet d'un hôpital, à traduire dans les deux sens, et la famille ne te laisse pas partir sans accepter quelque chose. On compte environ sept mille langues dans le monde, et la moitié d'entre elles ont moins de dix mille locuteurs.|病院の窓口で三十分、双方の言葉を訳して立っていたら、家族はどうしても受け取ってくれと言って聞かなかった。世界で数えられている言語は7000ほどあり、その半分は話し手が一万人を切っている。",
  ),
  ev(
    "parcel-home", "loss", [], "📦", 180,
    "Sending it home|Mandarlo a casa|Le renvoyer au pays|荷物を家に送る",
    "The bag will not close, so the rest goes into a box at the post office and the postage costs more than what is in it. Under the postal union's rules the country that delivers your parcel is paid by the country that posted it, and the counters set their prices from those accounts.|La bolsa ya no cierra, así que el resto va en una caja de correos y el franqueo cuesta más que su contenido. Según las reglas de la unión postal, al país que entrega el paquete le paga el país que lo envió, y de esas cuentas salen las tarifas del mostrador.|Le sac ne ferme plus : le reste part dans un carton à la poste et l'affranchissement coûte plus cher que le contenu. Selon les règles de l'union postale, le pays qui distribue le colis est payé par celui qui l'a expédié, et c'est de ces comptes que sortent les tarifs du guichet.|鞄が閉まらなくなったので、残りは郵便局で箱に詰めて送った。送料は中身より高くついた。万国郵便連合の取り決めでは、配達する国の取り分は差し出した国が払うことになっていて、窓口の料金はその精算から決まる。",
  ),
  ev(
    ...
    "It is issued on arrival, it is cash only, and the notes must be clean, unmarked and not too old. A queue forms behind you while somebody holds your money up to the light.|Se expide a la llegada, solo en efectivo, y los billetes tienen que estar limpios, sin marcas y no demasiado viejos. Se forma cola detrás de ti mientras alguien mira tu dinero al trasluz.|Il se délivre à l'arrivée, en espèces uniquement, et les billets doivent être propres, sans marque et pas trop anciens. Une file se forme derrière toi pendant qu'on regarde ton argent à la lumière.|到着時に発給されるが、支払いは現金のみ。紙幣は汚れておらず、書き込みがなく、あまり古くないものに限られる。誰かがあなたの金を透かして見ているあいだ、後ろには列ができていく。",
  ),
  ...
  ev(
    ...
    "You play for two hours on a marked square of tiles in a station passage and the case fills with six kinds of coin. The London Underground made busking legal in 2003 and now auditions for its pitches; before that, everyone who played there was breaking the byelaws.|Tocas dos horas sobre un cuadrado marcado en el suelo de un pasillo de estación y el estuche se llena de monedas de seis países. El metro de Londres legalizó la música callejera en 2003 y ahora hace audiciones para cada sitio; antes, todo el que tocaba allí incumplía la norma.|Tu joues deux heures sur un carré marqué au sol dans un couloir de gare et l'étui se remplit de pièces de six pays. Le métro de Londres a légalisé les musiciens de rue en 2003 et fait passer des auditions pour chaque emplacement ; avant cela, quiconque y jouait était en infraction.|駅の通路の、床にしるしのある一角で二時間弾いたら、ケースに六か国の硬貨がたまった。ロンドンの地下鉄が路上演奏を合法にしたのは2003年で、いまは場所ごとにオーディションがある。それ以前にそこで弾いていた人は、みな規則違反だった。",
    [1, 2, 3, 4, 5],
  ),
  ev(
    "berth-supplement", "loss", ["eur"], "🛏️", 200,
    "A ticket is not a bed|Un billete no es una cama|Un billet n'est pas un lit|切符と寝台は別物",
    "The ticket is valid for the night train but not for anywhere to lie down, and the conductor sells you the last berth in the corridor at his own unhurried pace. Night trains had almost disappeared from western Europe by 2016 and have been coming back, route by route, ever since.|El billete vale para el tren nocturno pero no para tumbarse en ninguna parte, y el revisor te vende la última litera en el pasillo, sin ninguna prisa. Los trenes nocturnos casi habían desaparecido de Europa occidental hacia 2016 y desde entonces vuelven, ruta a ruta.|Le billet est valable pour le train de nuit mais pas pour s'allonger, et le contrôleur te vend la dernière couchette dans le couloir, sans se presser. Les trains de nuit avaient presque disparu d'Europe de l'Ouest vers 2016 ; ils reviennent depuis, ligne après ligne.|切符は夜行列車に有効だが、横になる場所の分は入っていない。車掌は廊下で、少しも急がずに最後の寝台を売ってくれた。西ヨーロッパの夜行列車は2016年頃にほぼ消えかけ、それから一路線ずつ戻ってきている。",
  ),
  ...
  ev(
    ...
    "Cement, dates and one motorcycle go aboard by hand along a plank, and you are paid at the end of the day in notes off a roll. The winter wind blows from the north-east from November, and the wooden boats still leave with it as they always did.|Cemento, dátiles y una motocicleta suben a bordo a mano por una tabla, y al final del día te pagan con billetes sacados de un fajo. El viento de invierno sopla del nordeste desde noviembre, y los barcos de madera siguen saliendo con él como siempre.|Du ciment, des dattes et une moto montent à bord à la main par une planche, et l'on te paie en fin de journée sur un rouleau de billets. Le vent d'hiver souffle du nord-est à partir de novembre, et les bateaux de bois partent toujours avec lui.|セメントと棗と、オートバイが一台。渡した板の上を人の手で運び上げ、日暮れに札束から抜いた紙幣で支払われる。冬の風は十一月から北東に吹き、木造の船はいまも昔と同じように、その風に乗って出ていく。",
    [7, 8, 9],
  ),
  ev(
    "harmattan-dust", "loss", ["afr"], "🌫️", 220,
    "The dust closes everything|El polvo lo cierra todo|La poussière ferme tout|砂塵で何もかも止まる",
    "The wind comes off the desert with the sky the colour of weak tea, the airfield shuts, and the road is done at walking pace behind a lorry you cannot see. The same dust crosses the Atlantic every year and puts phosphorus on the floor of the Amazon.|El viento baja del desierto con el cielo color de té flojo, cierra el aeródromo y la carretera se hace al paso, detrás de un camión que no ves. Ese mismo polvo cruza el Atlántico cada año y deja fósforo en el suelo de la Amazonia.|Le vent descend du désert, le ciel prend la couleur d'un thé léger, l'aérodrome ferme et la route se fait au pas derrière un camion qu'on ne voit pas. Cette même poussière traverse l'Atlantique chaque année et dépose du phosphore sur le sol de l'Amazonie.|砂漠から風が来て、空は薄い紅茶の色になる。飛行場は閉鎖、道路は見えないトラックの後ろを歩く速さでついて行くしかない。この砂塵は毎年大西洋を渡り、アマゾンの森の地面にリンを供給している。",
    [8, 9, 10],
  ),
  ...
  ev(
    ...
    "You go with a crew that starts in Texas in May and finishes on the Canadian prairie in September, cutting whatever is ripe and moving on the same night. The wheat ripens about a hundred and fifty kilometres further north every week, and the machines follow it at exactly that speed.|Vas con una cuadrilla que empieza en Texas en mayo y acaba en la pradera canadiense en septiembre, segando lo que está maduro y moviéndose esa misma noche. El trigo madura unos ciento cincuenta kilómetros más al norte cada semana, y las máquinas lo siguen justo a esa velocidad.|Tu pars avec une équipe qui commence au Texas en mai et finit dans la prairie canadienne en septembre, coupant ce qui est mûr et repartant le soir même. Le blé mûrit environ cent cinquante kilomètres plus au nord chaque semaine, et les machines le suivent exactement à cette allure.|五月にテキサスで始め、九月にカナダの平原で終える刈り取り班に加わった。熟れたところを刈り、その晩のうちに次へ移る。小麦は一週間ごとに150キロほど北で熟していき、機械はちょうどその速さで追いかける。",
    [1, 2, 3, 4, 5],
  ),
  ev(
    ...
    "The total looks reasonable until you learn that a fifth of it again is expected, and the face across the counter makes that perfectly clear. The federal wage for tipped work has stood at two dollars and thirteen cents an hour since 1991; the rest is supposed to come from you.|El total parece razonable hasta que te enteras de que se espera otro veinte por ciento, y la cara del otro lado del mostrador lo deja clarísimo. El salario federal del trabajo con propina lleva en dos dólares con trece centavos la hora desde 1991: el resto ha de salir de ti.|Le total paraît raisonnable jusqu'à ce qu'on t'apprenne qu'on attend un cinquième de plus, et le visage en face du comptoir le dit très bien. Le salaire fédéral des métiers à pourboire est de deux dollars treize de l'heure depuis 1991 : le reste est censé venir de toi.|合計はまともに見えたが、そこにもう二割を足すのが当然だと知らされる。カウンターの向こうの顔がそれを何より雄弁に告げている。チップを前提とする職の連邦最低賃金は1991年から時給2ドル13セントのまま。残りは客が出すことになっている。",
  ),
  ...
  ev(
    ...
    "You help load sacks and gas bottles all afternoon and are given deck passage and a fare for it, and you tie up between two families who have done this a dozen times. Belém to Manaus takes about four days going up and less coming down, and everybody sleeps in rows, touching.|Ayudas a cargar sacos y bombonas toda la tarde y te dan pasaje de cubierta más una paga, y te amarras entre dos familias que ya lo han hecho una docena de veces. De Belém a Manaos son unos cuatro días aguas arriba y menos al bajar, y todos duermen en filas, rozándose.|Tu aides à charger sacs et bouteilles de gaz tout l'après-midi, et l'on te donne le passage sur le pont plus un salaire ; tu t'amarres entre deux familles qui ont fait le voyage dix fois. De Belém à Manaus, il faut environ quatre jours en montant et moins en descendant, et tout le monde dort en rangs serrés.|午後いっぱい麻袋とガスボンベを積むのを手伝ったら、甲板の乗船と手間賃をくれた。何度もこの船に乗っている二家族のあいだにハンモックを吊る。ベレンからマナウスまで、上りはおよそ四日、下りはもっと早い。皆が触れ合うほどの間隔で並んで眠る。",
  ),
  ev(

...
export const GHANA_SPIRIT = {
  ...
  wakeFact: t(
    "<b>Behind the story:</b> in the oldest Anansi tales the spider is never truly evil, only endlessly hungry for status and stories, and he is regularly outwitted in turn by his own son Ntikuma or by animals who see his trick coming.|<b>Tras la historia:</b> en los relatos más antiguos de Anansi, la araña nunca es realmente malvada, solo insaciablemente ávida de estatus e historias, y con frecuencia es superada a su vez por su propio hijo Ntikuma o por animales que anticipan su treta.|<b>Derrière l'histoire :</b> dans les contes les plus anciens, l'araignée n'est jamais vraiment mauvaise, seulement insatiablement avide de statut et d'histoires, et elle se fait régulièrement rouler à son tour par son propre fils Ntikuma ou par des animaux qui voient venir son piège.|<b>物語の背景:</b> もっとも古いアナンシ物語では、このクモは本当に悪ではなく、ただ地位と物語に対して底なしの渇望を抱いているだけとされ、実の息子ンティクマや、罠を見抜いた動物たちにしばしば逆に出し抜かれる。",
  ),
  pleased: t(
...
export const GHANA_DOOM = [
  ...
  {
    id: "owarebet",
    n: t("Losing badly at oware|Perdiendo feo al oware|Une lourde défaite à l'oware|オワレの勝負に負ける"),
    t: t(
      "The pits emptied one after another faster than the stake could be argued down, and the old man under the mango tree who has been playing oware in that same spot for as long as anyone remembers collected the coins without so much as looking up from the board. Ayo, as the game is also known, has been played across West Africa with carved wooden boards and captured seeds for so long that nobody can say exactly how old the version being lost here actually is.|Los hoyos se fueron vaciando uno tras otro más deprisa de lo que se pudo negociar la apuesta a la baja, y el anciano bajo el árbol de mango, que lleva jugando al oware en ese mismo lugar desde que nadie recuerda otra cosa, recogió las monedas sin siquiera levantar la vista del tablero. El ayo, como también se conoce el juego, se ha jugado por toda África Occidental con tableros de madera tallada y semillas capturadas durante tanto tiempo que nadie puede decir con certeza cuán antigua es en realidad la partida que aquí se está perdiendo.|Les trous se sont vidés les uns après les autres plus vite qu'on n'a pu négocier la mise à la baisse, et le vieil homme sous le manguier, qui joue à l'oware à cet endroit précis depuis des temps immémoriaux, a ramassé les pièces sans même lever les yeux du plateau. L'ayo, comme on appelle aussi ce jeu, se joue dans toute l'Afrique de l'Ouest avec des plateaux de bois sculpté et des graines capturées depuis si longtemps que personne ne sait dire au juste l'âge de la partie qu'on est en train de perdre ici.|穴が次々と空になっていくのは、賭け金を値切る間もないほど速く、マンゴーの木の下で誰の記憶にもある限りずっと同じ場所でオワレを打ってきた老人は、盤から顔も上げずに硬貨を集めていった。「アヨ」とも呼ばれるこの遊びは、彫刻を施した木の盤と取った種を使って西アフリカ中で長く打たれてきたため、いまここで負けている勝負がいったいどれほど古いものの続きなのか、誰にも正確には言えない。",
    ),
  },
  {
    id: "fantasycoffin",
    n: t("A fantasy-coffin funeral blocks the road|Un funeral con ataúd fantástico bloquea la vía|Un enterrement au cercueil fantaisie bloque la route|ファンタジーコフィンの葬列で道が塞がる"),
    t: t(
      "The hearse crawling through the intersection was shaped like a fifteen-foot cocoa pod, trailed by a brass band and mourners in matching cloth walking at a funeral's own unhurried pace, and every car on the road simply waited rather than try to pass. Ga carpenters around Teshie and Nungua have built these 'proverb boxes' — coffins shaped like a fish, a Bible, a cocoa pod or whatever the dead person's life called for — since the mid-twentieth century, and the best of them now sell to museums as sculpture as often as they bury anyone.|El coche fúnebre que avanzaba a paso de tortuga por el cruce tenía forma de una mazorca de cacao de cuatro metros y medio, seguido de una banda de metales y dolientes con telas a juego caminando al paso pausado propio de un funeral, y todos los coches de la vía simplemente esperaron en lugar de intentar pasar. Los carpinteros ga de Teshie y Nungua llevan construyendo desde mediados del siglo XX estos 'ataúdes proverbio' —con forma de pez, de Biblia, de mazorca de cacao o de lo que pidiera la vida del difunto—, y los mejores se venden hoy a museos como escultura tan a menudo como entierran a alguien.|Le corbillard qui avançait au pas dans le carrefour avait la forme d'une cabosse de cacao de quatre mètres cinquante, suivi d'une fanfare et de personnes en deuil vêtues d'un même tissu marchant au rythme tranquille propre à un enterrement, et toutes les voitures se sont simplement arrêtées plutôt que de tenter de dépasser. Les menuisiers ga de Teshie et Nungua fabriquent depuis le milieu du XXe siècle ces « cercueils-proverbes » — en forme de poisson, de Bible, de cabosse de cacao ou de tout ce que la vie du défunt appelait —, et les meilleurs se vendent aujourd'hui à des musées comme sculptures aussi souvent qu'ils servent à enterrer quelqu'un.|交差点をのろのろと進む霊柩車は全長4メートルを超すカカオの実の形をしており、ブラスバンドと揃いの布をまとった会葬者たちが葬儀ならではのゆっくりした足取りで続いた。道にいた車はどれも追い越そうとせず、ただ待っていた。テシエやヌングアあたりのガ人の指物師たちは20世紀半ばから、魚やバイブルやカカオの実など、故人の生涯にちなんだ形の「諺の箱」と呼ばれる棺を作ってきた。出来のよいものはいまでは、誰かを弔うのと同じくらいの頻度で彫刻作品として美術館に売られている。",
    ),
  },
  {
    id: "mudroad",

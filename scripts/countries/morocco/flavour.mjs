...
export const MOROCCO_SEASONS = [
  ...
  },
  {
    ...
    f: t(
      "Throne Day marks the anniversary of King Mohammed VI's accession on 30 July 1999, and government offices, schools and many private businesses close for the day while provincial governors host formal receptions in his honour.|El Día del Trono conmemora el aniversario de la subida al trono del rey Mohamed VI el 30 de julio de 1999, y las oficinas del gobierno, las escuelas y muchos negocios privados cierran ese día mientras los gobernadores provinciales ofrecen recepciones formales en su honor.|La Fête du Trône commémore l'anniversaire de l'accession au trône du roi Mohammed VI le 30 juillet 1999, et les administrations, les écoles et de nombreuses entreprises privées ferment ce jour-là tandis que les gouverneurs de province organisent des réceptions officielles en son honneur.|王位記念日は1999年7月30日のムハンマド6世国王の即位記念日で、この日は官公庁や学校、多くの民間企業が休業し、各県知事は国王を称える正式な式典を催す。",
    ),
  },
  {
    e: "🌙",
  ...
  },
  {
    ...
    f: t(
      "Majhoul, the variety most prized at the festival, very nearly disappeared in the twentieth century when a fungal disease called bayoud wiped out most of Morocco's older palm groves, and much of what's sold today comes from disease-resistant stock replanted only in recent decades.|El majhoul, la variedad más apreciada del festival, estuvo a punto de desaparecer en el siglo XX cuando una enfermedad fúngica llamada bayoud arrasó la mayoría de los palmerales más antiguos de Marruecos, y buena parte de lo que se vende hoy procede de plantones resistentes replantados solo en las últimas décadas.|La majhoul, la variété la plus prisée du festival, a bien failli disparaître au XXe siècle lorsqu'une maladie fongique appelée bayoud a décimé la plupart des vieilles palmeraies marocaines, et une grande partie de ce qui se vend aujourd'hui provient de plants résistants replantés seulement ces dernières décennies.|祭りでもっとも珍重される品種マジュールは、20世紀に「バユード」と呼ばれる菌類の病気がモロッコの古いナツメヤシ園の大半を壊滅させた際、ほとんど失われかけた。いま売られているものの多くは、ここ数十年のうちに植え直された耐病性の株に由来する。",
    ),
  },
  {
    e: "🕊️",
    ...
    f: t(
      "The Green March marks the anniversary of a mass civilian demonstration organized in 1975, one of the largest coordinated public marches of its kind anywhere at the time; Independence Day twelve days later marks the end of the French and Spanish protectorates in 1956.|La Marcha Verde conmemora el aniversario de una manifestación civil masiva organizada en 1975, una de las mayores marchas públicas coordinadas de su tipo en cualquier lugar de la época; el Día de la Independencia, doce días después, marca el fin de los protectorados francés y español en 1956.|La Marche Verte commémore l'anniversaire d'une manifestation civile massive organisée en 1975, l'une des plus grandes marches publiques coordonnées de ce type à l'époque ; la Fête de l'Indépendance, douze jours plus tard, marque la fin des protectorats français et espagnol en 1956.|緑の行進は1975年に組織された大規模な民衆行進の記念日で、当時としてはこの種のものとして世界でも指折りの規模の統制された行進だった。12日後の独立記念日は、1956年にフランスとスペインの保護領が終わったことを指す。",
    ),
  },
  {
    e: "🫒",
    ...
    f: t(
      "The first pressing, or first cold extraction, must happen within about 24 hours of picking to keep the oil's acidity low, which is why olive presses run around the clock during the opening weeks of the season, and clarified oil only appears in shops once the cloudy first batches have settled for a few weeks.|La primera prensada, o primera extracción en frío, debe hacerse en las 24 horas siguientes a la recolección para mantener baja la acidez del aceite, por lo que las almazaras funcionan sin parar durante las primeras semanas de temporada, y el aceite clarificado solo llega a las tiendas cuando los primeros lotes turbios llevan varias semanas reposando.|La première pression, ou première extraction à froid, doit avoir lieu dans les 24 heures suivant la cueillette pour garder une faible acidité, ce qui explique pourquoi les pressoirs tournent sans relâche durant les premières semaines de la saison, et l'huile clarifiée n'apparaît en boutique qu'après que les premiers lots troubles ont décanté plusieurs semaines.|初搾り(低温での最初の抽出)は酸度を低く保つため摘み取りからおよそ24時間以内に行わなければならず、そのため搾油所はシーズン最初の数週間、昼夜を問わず稼働し続ける。清澄なオイルが店に並ぶのは、濁った最初の搾りが数週間かけて沈殿したあとになる。",
    ),
  },
  {
    e: "🏔️",
  ...
  },
  {
    ...
    f: t(
      "Blossom appears here weeks before the almonds themselves are ready to pick, since flowering happens before the leaves even emerge; the actual nut harvest comes only in late summer, so the festival celebrates the promise of a crop rather than the crop itself.|La floración aparece aquí semanas antes de que las propias almendras estén listas para recoger, ya que florecen incluso antes de que salgan las hojas; la cosecha real del fruto seco llega solo a finales del verano, así que el festival celebra la promesa de una cosecha más que la cosecha en sí.|La floraison apparaît ici des semaines avant que les amandes elles-mêmes ne soient prêtes à être cueillies, car elle survient avant même l'apparition des feuilles ; la récolte réelle des fruits secs n'a lieu qu'à la fin de l'été, si bien que la fête célèbre la promesse d'une récolte plutôt que la récolte elle-même.|花はここでアーモンドの実そのものが収穫できるようになる何週間も前に咲く。葉が出るより先に花が咲くためで、実際の収穫は晩夏になってからにすぎない。つまりこの祭りは収穫そのものではなく、収穫への期待を祝っている。",
    ),
  },
  {
    e: "🍊",
    ...
    f: t(
      "Distilling orange-flower water takes roughly three kilograms of fresh petals to produce a single litre, and the plain around Fez and Meknes supplies a large share of what's sold nationwide, most of it still collected by hand before the heat of the day can wilt the blossoms.|Destilar agua de azahar requiere unos tres kilos de pétalos frescos para producir un solo litro, y la llanura en torno a Fez y Meknes suministra buena parte de lo que se vende en todo el país, la mayoría recogida aún a mano antes de que el calor del día marchite las flores.|Distiller de l'eau de fleur d'oranger nécessite environ trois kilogrammes de pétales frais pour produire un seul litre, et la plaine autour de Fès et Meknès fournit une bonne part de ce qui se vend dans tout le pays, la majeure partie encore récoltée à la main avant que la chaleur du jour ne flétrisse les fleurs.|オレンジフラワーウォーターを1リットル蒸留するにはおよそ3キログラムの生の花びらが要り、フェズとメクネスを囲む平野が全国で売られる量の大きな割合を供給している。その多くはいまも、日中の暑さで花がしおれる前に手摘みされる。",
    ),
  },
];

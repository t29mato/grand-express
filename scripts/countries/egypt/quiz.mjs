...
export const EGYPT_QUIZ = [
  ...
  q(
    9,
    "In March 2024, Egypt's central bank let the pound float freely again under a new IMF-backed programme, at the same time as a huge foreign investment deal was announced for a stretch of Mediterranean coast. What was that development deal called?|En marzo de 2024, el banco central de Egipto volvió a dejar flotar libremente la libra bajo un nuevo programa respaldado por el FMI, a la vez que se anunciaba un enorme acuerdo de inversión extranjera para un tramo de costa mediterránea. ¿Cómo se llamó ese acuerdo de desarrollo?|En mars 2024, la banque centrale d'Égypte a de nouveau laissé flotter librement la livre dans le cadre d'un nouveau programme soutenu par le FMI, en même temps qu'était annoncé un immense accord d'investissement étranger pour un tronçon de côte méditerranéenne. Comment s'appelait cet accord de développement?|2024年3月、エジプト中央銀行は新たなIMF支援計画のもとで再びポンドを完全変動相場に移行させたが、それと同時期に地中海沿岸の一角をめぐる巨額の海外投資契約が発表された。この開発契約は何と呼ばれるか?",
    [
    ...
    0,
    "The deal, worth about $35 billion, saw the United Arab Emirates take the lead in developing a large stretch of coastline west of Alexandria, one of the largest single foreign investment agreements in Egypt's history.|El acuerdo, valorado en unos 35.000 millones de dólares, situó a los Emiratos Árabes Unidos al frente del desarrollo de un gran tramo de costa al oeste de Alejandría, uno de los mayores acuerdos de inversión extranjera individuales en la historia de Egipto.|L'accord, d'une valeur d'environ 35 milliards de dollars, a vu les Émirats arabes unis prendre la tête du développement d'un long tronçon de littoral à l'ouest d'Alexandrie, l'un des plus importants accords d'investissement étranger unique de l'histoire de l'Égypte.|およそ350億ドル規模のこの契約により、アラブ首長国連邦がアレクサンドリア西方の広い海岸線の開発を主導することになった。エジプト史上でも指折り大規模な、単発の外国投資契約の一つである。",
  ),
  q(
    9,
  ...
  q(
    ...
    0,
    "Ethiopia announced the project just days after the fall of Egypt's president Hosni Mubarak in the 2011 uprising, timing that Egyptian commentators have long noted was unlikely to be coincidental.|Etiopía anunció el proyecto solo días después de la caída del presidente egipcio Hosni Mubarak en el levantamiento de 2011, una coincidencia temporal que comentaristas egipcios llevan tiempo señalando como poco casual.|L'Éthiopie annonça le projet à peine quelques jours après la chute du président égyptien Hosni Moubarak lors du soulèvement de 2011, un timing que des commentateurs égyptiens jugent depuis longtemps peu fortuit.|エチオピアがこの計画を発表したのは、2011年の蜂起でエジプトのホスニー・ムバーラク大統領が失脚してからわずか数日後のことで、この時期の一致は偶然ではないだろうと、エジプトの論者は長く指摘してきた。",
  ),
  q(
    9,

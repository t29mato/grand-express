...
export const AFRICA_QUIZ = [
  ...
  q(
    7,
    "Cabinda, which produces most of its oil, is cut off from the rest of which country by a strip of Congolese territory reaching the sea?|Cabinda, que produce la mayor parte de su petróleo, está separada del resto de ¿qué país por una franja de territorio congoleño que llega al mar?|Cabinda, qui produit l'essentiel de son pétrole, est séparée du reste de quel pays par une bande de territoire congolais atteignant la mer ?|石油の大半を産出するカビンダが、海に達するコンゴ領の帯によって本土から切り離されているのはどの国か?",
    ...
    0,
    "The Congo River's mouth gives the Democratic Republic of the Congo a narrow corridor to the Atlantic, and that corridor severs Cabinda from Angola proper by some 60km. The province holds a small fraction of Angola's people but produces the majority of its oil, which is why a separatist movement there has outlasted the war that ended in 2002.|La desembocadura del río Congo da a la República Democrática del Congo un estrecho corredor al Atlántico, y ese corredor separa Cabinda de Angola propiamente dicha por unos 60 km. La provincia alberga una pequeña parte de la población angoleña pero produce la mayoría de su petróleo, razón por la cual un movimiento separatista ha sobrevivido allí a la guerra que terminó en 2002.|L'embouchure du fleuve Congo donne à la République démocratique du Congo un étroit corridor vers l'Atlantique, et ce corridor sépare le Cabinda de l'Angola proprement dit sur une soixantaine de kilomètres. La province abrite une faible part de la population angolaise mais produit la majorité de son pétrole, ce qui explique qu'un mouvement séparatiste y ait survécu à la guerre achevée en 2002.|コンゴ川の河口が、コンゴ民主共和国に大西洋への細い回廊を与えている。その回廊が、カビンダをアンゴラ本土からおよそ60キロメートル切り離している。この州が抱えるのはアンゴラの人口のごく一部だが、産出する石油は国全体の過半を占める。2002年に終わった戦争よりも長く、ここの分離独立運動が続いてきた理由がそこにある。",
  ),
  q(
    7,
  ...
  q(
    7,
    "FESPACO, the largest film festival on the African continent, has been held every two years since 1969 in the capital of which country?|El FESPACO, el mayor festival de cine del continente africano, se celebra cada dos años desde 1969 en la capital de ¿qué país?|Le FESPACO, le plus grand festival de cinéma du continent africain, se tient tous les deux ans depuis 1969 dans la capitale de quel pays ?|アフリカ大陸で最大の映画祭FESPACOが1969年から2年に1度開かれている首都を持つ国は?",
    ["Burkina Faso|Burkina Faso|Le Burkina Faso|ブルキナファソ", "Benin|Benín|Le Bénin|ベナン", "Mali|Malí|Le Mali|マリ"],
    0,
    "The Panafrican Film and Television Festival of Ouagadougou accepts only films made by African filmmakers and produced chiefly in Africa, and its top prize is named the Étalon de Yennenga after a legendary Mossi princess. A landlocked country with no film industry of its own to speak of became the place African cinema comes to be seen.|El Festival Panafricano de Cine y Televisión de Uagadugú solo admite películas de cineastas africanos producidas principalmente en África, y su premio mayor se llama Étalon de Yennenga, por una legendaria princesa mossi. Un país sin salida al mar y sin apenas industria cinematográfica propia se convirtió en el lugar donde el cine africano se deja ver.|Le Festival panafricain du cinéma et de la télévision de Ouagadougou n'accepte que des films réalisés par des cinéastes africains et produits principalement en Afrique, et son grand prix porte le nom d'Étalon de Yennenga, d'après une légendaire princesse mossi. Un pays enclavé, sans véritable industrie du cinéma, est devenu le lieu où le cinéma africain se donne à voir.|ワガドゥグ全アフリカ映画テレビ祭は、アフリカの映画作家が撮り、主にアフリカで製作された作品しか受け付けない。最高賞の名は、モシの伝説の王女にちなむ「イェネンガの種馬」である。内陸国で、自前の映画産業と呼べるものをほとんど持たない国が、アフリカ映画が見られる場所になった。",
  ),
  q(
    7,

...
export const AFRICA_QUIZ = [
  ...
  q(
    ...
    0,
    "The coup, which historians widely describe as covertly encouraged by the CIA amid Cold War anxiety over Nkrumah's socialist leanings and pan-Africanist ambitions, ended his rule for good; he died in exile in Guinea in 1972.|El golpe, que los historiadores describen ampliamente como alentado en secreto por la CIA en medio de la inquietud de la Guerra Fría por las inclinaciones socialistas y las ambiciones panafricanistas de Nkrumah, puso fin definitivo a su gobierno; murió en el exilio en Guinea en 1972.|Le coup d'État, que les historiens décrivent largement comme secrètement encouragé par la CIA dans un contexte d'inquiétude de la guerre froide face aux penchants socialistes et aux ambitions panafricanistes de Nkrumah, mit fin pour de bon à son règne ; il mourut en exil en Guinée en 1972.|このクーデターは、ンクルマの社会主義的傾向と汎アフリカ主義的な野心に対する冷戦下の懸念からCIAが密かに後押ししたと歴史家の多くが見ており、彼の統治に終止符を打った。ンクルマは1972年、亡命先のギニアで死去した。",
  ),
  q(
    9,

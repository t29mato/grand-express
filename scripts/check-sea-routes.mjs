 ...
 */
const KEPT = new Map([
  ["kyushu:kagoshima-tanegashima", "種子島への実在のフェリー。611pxの長い航路で、両端がそれぞれの島の海岸に近いぶんだけ自分の陸に触れている(13%)"],
  ["kyushu:goto-nagasaki", "五島列島への実在のフェリー。533pxの航路で、長崎半島と福江島の両端をかすめるだけ(13%)"],
  ["kyushu:kumamoto-omuta", "有明海沿いを走る実在の鹿児島本線。海岸線が湾なりに深く入り込むため、直線が湾を横切る。担当がジオメトリ調整を2回試して両方とも悪化した"],
  ["kyushu:nakatsu-oita", "周防灘沿いを走る実在の日豊本線。上と同じ理由(21%)"],
  ["hokkaido:esashi-okushiri", "江差―奥尻の実在フェリー。投影の縮尺では航路の半分弱が本島の海岸線をかすめる。島の座標と都市座標を複数試して43pxが最良値だった"],

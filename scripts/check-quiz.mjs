...
const ACCEPTED = [
  ...
  // **誤答のほうにも英語が要る。**「.tv は何の略か」を訊く以上、
  // 選ばせる候補は英語の綴りでなければ比べられない。
  { c: "oceania", has: "travel", why: "同じ問いの誤答。二文字の略の候補なので英語の綴りが要る" },
  // アルゼンチンの二人称。**綴りそのものを見分ける問い**なので原語が要る。
  { c: "argentina", has: "vos", why: "アルゼンチンの二人称 vos を usted/che と見分ける問題。綴りが問いの中身" },
  { c: "argentina", has: "usted", why: "同上" },
  { c: "argentina", has: "che", why: "同上" },
  // チリの二人称・間投詞。**綴りそのものを見分ける問い。**
  { c: "chile", has: "pues", why: "チリの語尾「ポ」が pues の縮約であることを訊く問題。綴りが問いの中身" },
  { c: "chile", has: "poh", why: "同上。別綴り" },
  { c: "chile", has: "che", why: "同じ問いの誤答。アルゼンチンの間投詞と見分けさせる" },
  { c: "chile", has: "rale", why: "同じ問いの誤答。メキシコの órale と見分けさせる" },
  { c: "colombia", has: "SCADTA", why: "航空会社の名前そのもの。訳すと問いが成立しない。6文字なので略号判定(2〜5文字)から漏れる" },
  { c: "colombia", has: "SPf", why: "ワクチン SPf66 の名称そのもの。大文字小文字が混ざるので略号判定から漏れる" },
...
const ACCEPTED_LEAKS = [
  ...
  { c: "oceania", ans: "トンガ", city: "パンガイ", why: "taboo の語源を訊く問題。カードは言葉に触れておらず、「トンガ」は火山名(フンガ・トンガ=フンガ・ハアパイ)と「トンガ当局」に出るだけ" },
  { c: "oceania", ans: "ヴィティレヴ島", city: "ラバサ", why: "スバがどちらの島にあるかを訊く問題。カードはスバの位置を書いておらず、ヴィティレヴ島は「観光客が向かう先」として出るだけ" },
  { c: "argentina", ans: "ブエノスアイレス", city: "ラ・プラタ", why: "首都を訊く問題。ラ・プラタは州都として首都と対比されるので地名が出るのは当然。枠の語" },
  { c: "argentina", ans: "メンドーサ", city: "サンラファエル", why: "ワインの中心地を訊く問題。サンラファエルはメンドーサ州内にあるので州名が出るのは当然" },
  { c: "argentina", ans: "フアン・ドミンゴ・ペロン", city: "サンフアン", why: "1948年の鉄道国有化を訊く問題。カードは1944年の地震と救援の話で、鉄道には触れていない" },
  { c: "argentina", ans: "ウルグアイ川", city: "コンコルディア", why: "国境の川を訊く問題。川沿いの町のカードに川の名が出るのは避けられず、川名から答えは自明" },
  // コロンビア。担当がカードを1件ずつ開いて判定し、本物2件は差し替え済み。
  { c: "colombia", ans: "ボゴタ", city: "ボゴタ", why: "首都名は一般常識。カードの「首都」は道のりと標高の説明の一部で、答えを教えていない" },
  { c: "colombia", ans: "1930年代", city: "バランキージャ", why: "蘭の国花指定年を訊く問題。カードの1930年代はボカス・デ・セニサの開削の話で、無関係な偶然の一致" },
  { c: "colombia", ans: "マグダレナ川", city: "マニサレス", why: "最長の川を訊く問題。カードは索道の目的地として川名を挙げるだけで、最上級の主張はしていない" },
  { c: "colombia", ans: "カウカ渓谷", city: "カリ", why: "小説『マリア』の舞台を訊く問題。カードは立地として言及するだけ" },
  { c: "colombia", ans: "20世紀", city: "ビジャビセンシオ", why: "画家デボラ・アランゴの活動時期を訊く問題。カードの20世紀は未完の鉄道の話" },
  // チリ。同じく担当が1件ずつ判定し、本物1件(ピスコ)は差し替え済み。
  { c: "chile", ans: "サンティアゴ", city: "サンティアゴ", why: "首都を訊く問題。首都の名を問えば必ずその都市自身のカードと一致する。構造上避けられない" },
  { c: "chile", ans: "アンデス山脈", city: "サンティアゴ", why: "東の国境をなす山脈を訊く問題。カードのAndesは盆地とスモッグの文脈で、国境には触れていない" },
  { c: "chile", ans: "ブドウ", city: "オバジェ", why: "北半球の冬に輸出する生食用ブドウを訊く問題。該当4枚はワインとブドウ畑の話で、その具体には触れていない" },
  { c: "chile", ans: "ボリビア", city: "アントファガスタ", why: "1836〜39年の連合戦争を訊く問題。カードが語るのは1879年の別の戦争。国名の一致のみ" },
  // キューバ。担当がカードを1件ずつ開いて判定し、本物4件は差し替え済み。
  { c: "cuba", ans: "ハバナ", city: "サンティアゴ・デ・クーバ", why: "現在の首都を訊く問題。カードにあるのは「かつての植民地首都」で、別の主張" },
  { c: "cuba", ans: "タバコ", city: "アルテミサ", why: "砂糖以外の葉の作物を訊く問題。カードは町の混作経済を書くだけで、一般常識の答えを示唆していない" },
  { c: "cuba", ans: "シエラ・マエストラ", city: "サンティアゴ・デ・クーバ", why: "最高峰のある山脈を訊く問題。カードは山脈名を出すが「最高峰がある」とは書いていない" },
  ...
  { c: "kyushu", ans: "1960年代", city: "飯塚", why: "天草五橋の完成年代を訊く問題。飯塚のカードの1960年代は炭鉱の閉山を指し、橋とは無関係" },

 ...
 * ## 水が水に見えていなかった
 *
 * 2026-08-09、二人が別々に見て**二人とも「茶色い土手」だと読んだ。**
 * 濁流を `#6b4a26` の半透明で `#59605c` の築堤に重ねていたので、
 * **水と地面が同じ茶色の系統に沈んでいた。**
 *
 * 直しかたは `ibaraki-mizu-ga-hikanai` と同じである。
 *
 * - **沈んでいるものを見せる。**水面の下にレールを薄く通し、
 *   冠水した柵の頭だけを水の上に出した。**水そのものより、沈んだ物のほうが水を語る**
 * - 水面のすぐ下に**空の映り込み**の帯を入れた。青みが一本入るだけで水になる
 * - 濁流の色を土手から離し、不透明度を上げた
 *
...
export function IndiaMonsoonflood() {
  return (
    <svg viewBox="0 0 400 210" role="img" aria-hidden="true">
      ...
      {/* 冠水した柵。**頭だけが水の上に残る。**沈んだ物が、水の深さを言う。 */}
      <g fill="#7b8a80">
        <rect x="24" y="112" width="5" height="46" />
        <rect x="76" y="114" width="5" height="46" />
        <rect x="128" y="116" width="5" height="46" />
        <rect x="24" y="118" width="109" height="4" />
      </g>
      ...
      <g className="imf-water">
        <path
          ...
          opacity="0.84"
        />
        {/* 空の映り込み。**青みが一本入るだけで、茶色の面が水になる。** */}
        <rect y="136" width="400" height="10" fill="#5b7d93" opacity="0.42" />
        {/* 水越しに透けるレール。**沈んでいるものを見せる。** */}
        <g fill="#c3bbaa" opacity="0.3">
          <rect y="146" width="400" height="9" />
          <rect y="186" width="400" height="10" />
        </g>
        <path

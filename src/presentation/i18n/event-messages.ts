...
const DOOM_LOG = {
  ...
  es: {
    ...
    doomCost: "Pérdida de {0}.",
    doomSkipNext: "Siguiente turno perdido.",
    doomSkipNextPaid: "Siguiente turno perdido y pérdida de {0}.",
    doomPropertyLost: "{0} de sus negocios cambian de manos.",
    doomMovedAway: "Lejos del destino.",
    doomItemTaken: "Le quitan un objeto.",
    doomNothing: "Sin pérdidas esta vez.",
  },
  fr: {
    spiritStruckLog: "👹 <b>{0}</b> — <b>{1}</b>. {2}",
    spiritStruckKingLog: "👹👹 <b>{0}</b> — <b>{1}</b>. {2} L'esprit est à pleine puissance.",
    doomCost: "Perte de {0}.",
    doomSkipNext: "Tour suivant perdu.",
    doomSkipNextPaid: "Tour suivant perdu et perte de {0}.",
    doomPropertyLost: "{0} de ses affaires changent de mains.",
    doomMovedAway: "Loin de la destination.",
    doomItemTaken: "Un objet lui est pris.",
    doomNothing: "Rien de perdu cette fois.",
  },
  ja: {
    spiritStruckLog: "👹 <b>{0}</b> — <b>{1}</b>。{2}",
